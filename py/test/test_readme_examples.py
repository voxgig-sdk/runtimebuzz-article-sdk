# RuntimebuzzArticle SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RuntimebuzzArticleSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RuntimebuzzArticleSDK(...) and RuntimebuzzArticleSDK.test(...) become
#      RuntimebuzzArticleSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "runtimebuzzarticle_sdk"
_SDK_CLASS = "RuntimebuzzArticleSDK"
...
_ENTITIES = {
    "ReadFinderIndex": "read_finder_index",
    "Search": "search",
}
