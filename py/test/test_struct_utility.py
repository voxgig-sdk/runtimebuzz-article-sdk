...
from runtimebuzzarticle_sdk.utility.voxgig_struct.voxgig_struct import (
...
class TestStructUtility(unittest.TestCase):
    ...
    def test_minor_joinurl(self):
        from runtimebuzzarticle_sdk.utility.voxgig_struct.voxgig_struct import join as struct_join
