...
from runtimebuzzarticle_sdk.runtimebuzzarticle_types import (
    ReadFinderIndex,
...
class ReadFinderIndexEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReadFinderIndexEntity(self._client, opts)
    ...
    def data_get(self) -> ReadFinderIndex:
    ...
    def match_get(self) -> ReadFinderIndex:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ReadFinderIndex:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ReadFinderIndex().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
