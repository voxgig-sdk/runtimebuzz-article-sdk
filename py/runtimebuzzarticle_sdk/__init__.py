...
from runtimebuzzarticle_sdk.utility import register

# Load features
from runtimebuzzarticle_sdk.feature.base_feature import RuntimebuzzArticleBaseFeature
from runtimebuzzarticle_sdk.features import _has_feature, _make_feature
...
class RuntimebuzzArticleSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RuntimebuzzArticleUtility()
        self._utility = utility

        from runtimebuzzarticle_sdk.config import shared_config
    ...
    def get_utility(self):
        return RuntimebuzzArticleUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RuntimebuzzArticleSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def ReadFinderIndex(self, data=None) -> "ReadFinderIndexEntity":
        """Entity factory: client.ReadFinderIndex().list() / client.ReadFinderIndex().load({"id": ...})."""
        from runtimebuzzarticle_sdk.entity.read_finder_index_entity import ReadFinderIndexEntity
        return ReadFinderIndexEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from runtimebuzzarticle_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RuntimebuzzArticleSDK":
        if sdkopts is None:
            sdkopts = {}
