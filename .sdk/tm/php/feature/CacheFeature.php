...
// RuntimebuzzArticle SDK cache feature
...
class RuntimebuzzArticleCacheFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _through(RuntimebuzzArticleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
