...
// RuntimebuzzArticle SDK streaming feature
...
class RuntimebuzzArticleStreamingFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _iterate(RuntimebuzzArticleResult $result): \Generator
    {
    ...
    private function _streamable(RuntimebuzzArticleContext $ctx): bool
    {
