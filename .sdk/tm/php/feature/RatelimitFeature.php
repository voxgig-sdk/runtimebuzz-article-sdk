...
// RuntimebuzzArticle SDK ratelimit feature
...
class RuntimebuzzArticleRatelimitFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _acquire(RuntimebuzzArticleContext $ctx): void
    {
    ...
    private function _track(RuntimebuzzArticleContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
