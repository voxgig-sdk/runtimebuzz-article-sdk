...
// RuntimebuzzArticle SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RuntimebuzzArticleTestFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    public function init(RuntimebuzzArticleContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RuntimebuzzArticleContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RuntimebuzzArticleParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RuntimebuzzArticleContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RuntimebuzzArticleContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = RuntimebuzzArticleParam::call($ctx, $k);
