...
// RuntimebuzzArticle SDK rbac feature
...
class RuntimebuzzArticleRbacFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _required(RuntimebuzzArticleContext $ctx): ?string
    {
    ...
    private function _reject(RuntimebuzzArticleContext $ctx, string $required): void
    {
    ...
    private function _track(RuntimebuzzArticleContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
