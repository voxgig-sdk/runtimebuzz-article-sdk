...
// RuntimebuzzArticle SDK idempotency feature
...
class RuntimebuzzArticleIdempotencyFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _mutating(RuntimebuzzArticleContext $ctx): bool
    {
