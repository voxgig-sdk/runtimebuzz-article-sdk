...
local function make_error_util(ctx, err)
  ...
  local msg = "RuntimebuzzArticleSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = RuntimebuzzArticleError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == RuntimebuzzArticleError then
