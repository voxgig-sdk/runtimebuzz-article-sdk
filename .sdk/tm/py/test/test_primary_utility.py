...
from projectname_sdk import RuntimebuzzArticleSDK
from projectname_sdk.core.spec import RuntimebuzzArticleSpec
from projectname_sdk.core.result import RuntimebuzzArticleResult
from projectname_sdk.core.response import RuntimebuzzArticleResponse
from projectname_sdk.core.operation import RuntimebuzzArticleOperation
from projectname_sdk.core.error import RuntimebuzzArticleError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import RuntimebuzzArticleBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RuntimebuzzArticleError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = RuntimebuzzArticleSDK.test(None, None)
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except RuntimebuzzArticleError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = RuntimebuzzArticleResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = RuntimebuzzArticleSDK.test(None, None)
        ...
        class TestInitFeature(RuntimebuzzArticleBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RuntimebuzzArticleBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = RuntimebuzzArticleSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = RuntimebuzzArticleSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RuntimebuzzArticleSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RuntimebuzzArticleSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RuntimebuzzArticleSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = RuntimebuzzArticleOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RuntimebuzzArticleSDK.test(None, setup_opts)
