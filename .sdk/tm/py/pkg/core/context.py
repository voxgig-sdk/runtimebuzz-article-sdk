...
from projectname_sdk.core.control import RuntimebuzzArticleControl
...
class RuntimebuzzArticleContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = RuntimebuzzArticleControl()
        ...
        if isinstance(sp, RuntimebuzzArticleSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RuntimebuzzArticleResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RuntimebuzzArticleResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return RuntimebuzzArticleOperation({})
        ...
        op = RuntimebuzzArticleOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return RuntimebuzzArticleError(code, msg, self)
