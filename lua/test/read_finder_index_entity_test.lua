...
describe("ReadFinderIndexEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set RUNTIMEBUZZARTICLE_TEST_READ_FINDER_INDEX_ENTID JSON to run live")
      return
    end
...
function read_finder_index_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("RUNTIMEBUZZARTICLE_TEST_READ_FINDER_INDEX_ENTID")
