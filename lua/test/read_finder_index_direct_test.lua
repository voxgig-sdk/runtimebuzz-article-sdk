...
describe("ReadFinderIndexDirect", function()
  it("should direct-load-read_finder_index", function()
    local setup = read_finder_index_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-read_finder_index", setup.live and "live" or "unit")
