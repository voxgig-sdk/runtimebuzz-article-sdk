...
local ReadFinderIndexEntity = {}
ReadFinderIndexEntity.__index = ReadFinderIndexEntity


function ReadFinderIndexEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReadFinderIndexEntity)
  self._name = "read_finder_index"
  self._client = client
...
function ReadFinderIndexEntity:get_name()
  return self._name
end


function ReadFinderIndexEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReadFinderIndexEntity.new(self._client, opts)
end
...
function ReadFinderIndexEntity:mark_deleted()
  self._deleted = true
end


function ReadFinderIndexEntity:deleted()
  return true == self._deleted
end


function ReadFinderIndexEntity:data_set(args)
  if args ~= nil then
...
function ReadFinderIndexEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReadFinderIndexEntity:match_set(args)
  if args ~= nil then
...
function ReadFinderIndexEntity:match_get()
...
function ReadFinderIndexEntity:stream(action, args, callopts)
...
---@param reqmatch ReadFinderIndexLoadMatch
---@param ctrl? table
---@return ReadFinderIndex
---@return string? err
function ReadFinderIndexEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ReadFinderIndexEntity:_run_op(ctx, post_done)
  local utility = self._utility
