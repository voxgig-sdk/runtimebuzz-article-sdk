...
type ReadFinderIndexEntity struct {
	name    string
	client  *core.RuntimebuzzArticleSDK
...
func NewReadFinderIndexEntity(client *core.RuntimebuzzArticleSDK, entopts map[string]any) *ReadFinderIndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReadFinderIndexEntity) GetName() string { return e.name }
...
func (e *ReadFinderIndexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReadFinderIndexEntity) Deleted() bool {
	return e.deleted
}


func (e *ReadFinderIndexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReadFinderIndexEntity(e.client, opts)
}

func (e *ReadFinderIndexEntity) Data(args ...any) any {
...
func (e *ReadFinderIndexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReadFinderIndex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReadFinderIndexEntity) DataTyped(data ...ReadFinderIndex) ReadFinderIndex {
	if len(data) > 0 {
		return typedFrom[ReadFinderIndex](e.Data(asMap(data[0])))
	}
	return typedFrom[ReadFinderIndex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReadFinderIndex (all fields
// optional at the wire level).
func (e *ReadFinderIndexEntity) MatchTyped(match ...ReadFinderIndex) ReadFinderIndex {
	if len(match) > 0 {
		return typedFrom[ReadFinderIndex](e.Match(asMap(match[0])))
	}
	return typedFrom[ReadFinderIndex](e.Match())
}
...
func (e *ReadFinderIndexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReadFinderIndexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReadFinderIndexLoadMatch and returns an ReadFinderIndex. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReadFinderIndexEntity) LoadTyped(reqmatch ReadFinderIndexLoadMatch, ctrl map[string]any) (ReadFinderIndex, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReadFinderIndex{}, err
	}
	return typedFrom[ReadFinderIndex](res), nil
}



func (e *ReadFinderIndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReadFinderIndexEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReadFinderIndexEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReadFinderIndexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReadFinderIndexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
