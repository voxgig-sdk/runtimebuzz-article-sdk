...
type Args struct {
	Entity string         `json:"entity" jsonschema:"read_finder_index | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RuntimebuzzArticleSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "runtimebuzz-article_list",
		Description: "List records from RuntimebuzzArticle. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "runtimebuzz-article_load",
		Description: "Load a single record from RuntimebuzzArticle. " +
...
func runOp(client *sdk.RuntimebuzzArticleSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RuntimebuzzArticleSDK, name string) (sdk.RuntimebuzzArticleEntity, error) {
	switch strings.ToLower(name) {
	case "read_finder_index":
		return client.ReadFinderIndex(nil), nil
	case "search":
