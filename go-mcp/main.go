// Command RuntimebuzzArticle-mcp is an MCP server exposing the RuntimebuzzArticle
// SDK as MCP tools.
//
// Two tools are registered:
//
//	RuntimebuzzArticle_list  — list records of an entity
//	RuntimebuzzArticle_load  — load a single record of an entity
//
