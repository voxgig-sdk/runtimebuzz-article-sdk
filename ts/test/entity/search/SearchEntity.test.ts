...
describe('SearchEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set RUNTIMEBUZZ_ARTICLE_TEST_SEARCH_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['RUNTIMEBUZZ_ARTICLE_TEST_SEARCH_ENTID']
