...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RUNTIMEBUZZ_ARTICLE_TEST_LIVE ||
    'TRUE' === process.env.RUNTIMEBUZZ_ARTICLE_TEST_OVERRIDE
  ) {
  ...
  m.RUNTIMEBUZZ_ARTICLE_TEST_EXPLAIN = process.env.RUNTIMEBUZZ_ARTICLE_TEST_EXPLAIN || m.RUNTIMEBUZZ_ARTICLE_TEST_EXPLAIN
