...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.RUNTIMEBUZZARTICLE_TEST_LIVE ||
    'TRUE' === process.env.RUNTIMEBUZZARTICLE_TEST_OVERRIDE
  ) {
  ...
  m.RUNTIMEBUZZARTICLE_TEST_EXPLAIN = process.env.RUNTIMEBUZZARTICLE_TEST_EXPLAIN || m.RUNTIMEBUZZARTICLE_TEST_EXPLAIN
