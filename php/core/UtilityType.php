...
// RuntimebuzzArticle SDK utility type

class RuntimebuzzArticleUtility
{
    ...
    public static function copy(RuntimebuzzArticleUtility $src): RuntimebuzzArticleUtility
    {
        $u = new RuntimebuzzArticleUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
