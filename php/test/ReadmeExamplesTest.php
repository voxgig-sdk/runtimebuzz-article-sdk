...
// RuntimebuzzArticle SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RuntimebuzzArticleSDK::test)
...
{
    private const SDK_CLASS = 'RuntimebuzzArticleSDK';
    ...
    private const SDK_BASE = 'runtimebuzzarticle_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../runtimebuzzarticle_sdk.php';
