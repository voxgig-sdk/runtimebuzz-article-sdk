...
// RuntimebuzzArticle SDK pipeline test
//
...
{
    private static function utility(): RuntimebuzzArticleUtility
    {
        return new RuntimebuzzArticleUtility();
    }
    ...
    private static function ctx(array $over = []): RuntimebuzzArticleContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RuntimebuzzArticleContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RuntimebuzzArticleError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RuntimebuzzArticleMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RuntimebuzzArticleMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RuntimebuzzArticleMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RuntimebuzzArticleSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RuntimebuzzArticleMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RuntimebuzzArticleResponse([]),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        [, $err] = RuntimebuzzArticleMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec([]),
            'response' => null,
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        [, $err] = RuntimebuzzArticleMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec(['step' => 's']),
            'response' => new RuntimebuzzArticleResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        [, $err] = RuntimebuzzArticleMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec(['step' => 's']),
            'response' => new RuntimebuzzArticleResponse(self::resp(200, ['v' => 1])),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        [, $err] = RuntimebuzzArticleMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec(['step' => 's']),
            'response' => new RuntimebuzzArticleResponse(self::resp(200, ['v' => 2])),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RuntimebuzzArticleMakeResponse::call($ctx);
    ...
    {
        $preset = new RuntimebuzzArticleResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec([]),
            'response' => new RuntimebuzzArticleResponse([]),
            'result' => new RuntimebuzzArticleResult([]),
        ...
        [$got, $err] = RuntimebuzzArticleMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RuntimebuzzArticleResult([])]);
        [, $err] = RuntimebuzzArticleMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RuntimebuzzArticleSpec([]), 'result' => null]);
        [, $err] = RuntimebuzzArticleMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RuntimebuzzArticleSpec(['step' => 's']),
            'result' => new RuntimebuzzArticleResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RuntimebuzzArticleMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RuntimebuzzArticleSpec(['step' => 's']),
            'result' => new RuntimebuzzArticleResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RuntimebuzzArticleOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RuntimebuzzArticleMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RuntimebuzzArticleResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RuntimebuzzArticleSpec([]),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RuntimebuzzArticleMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RuntimebuzzArticleMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RuntimebuzzArticleError('boom', 'boom');
        $utility->fetcher = function (RuntimebuzzArticleContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RuntimebuzzArticleSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RuntimebuzzArticleMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RuntimebuzzArticleContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RuntimebuzzArticleMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RuntimebuzzArticleResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RuntimebuzzArticleMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RuntimebuzzArticleContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RuntimebuzzArticleSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RuntimebuzzArticleMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RuntimebuzzArticleResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RuntimebuzzArticleSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RuntimebuzzArticleMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RuntimebuzzArticleMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RuntimebuzzArticleMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RuntimebuzzArticleResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RuntimebuzzArticleDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RuntimebuzzArticleResult(['ok' => false])]);
        $this->expectException(RuntimebuzzArticleError::class);
        RuntimebuzzArticleDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RuntimebuzzArticleResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RuntimebuzzArticleMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RuntimebuzzArticleMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RuntimebuzzArticleBaseFeature();
        $b = new RuntimebuzzArticleBaseFeature();
        RuntimebuzzArticleFeatureAdd::call($ctx, $a);
        RuntimebuzzArticleFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RuntimebuzzArticleBaseFeature
    {
        $f = new RuntimebuzzArticleBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RuntimebuzzArticleFeatureAdd::call($ctx, self::named_feature('a'));
        RuntimebuzzArticleFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        RuntimebuzzArticleFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        RuntimebuzzArticleFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        RuntimebuzzArticleFeatureAdd::call($ctx, $replace);
        ...
        RuntimebuzzArticleFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RuntimebuzzArticleContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RuntimebuzzArticleSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RuntimebuzzArticlePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RuntimebuzzArticlePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RuntimebuzzArticleResponse(['headers' => null]),
            'result' => new RuntimebuzzArticleResult([]),
        ]);
        RuntimebuzzArticleResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RuntimebuzzArticleResultBody::call($ctx);
