...
class ReadFinderIndexEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set RUNTIMEBUZZARTICLE_TEST_READ_FINDER_INDEX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function read_finder_index_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("RUNTIMEBUZZARTICLE_TEST_READ_FINDER_INDEX_ENTID");
