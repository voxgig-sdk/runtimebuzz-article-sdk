...
// RuntimebuzzArticle SDK audit feature
...
class RuntimebuzzArticleAuditFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _emit(RuntimebuzzArticleContext $ctx, string $outcome): void
    {
