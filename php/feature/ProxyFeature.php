...
// RuntimebuzzArticle SDK proxy feature
...
class RuntimebuzzArticleProxyFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    public function init(RuntimebuzzArticleContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RuntimebuzzArticleContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
