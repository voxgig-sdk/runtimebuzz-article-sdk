...
// RuntimebuzzArticle SDK netsim feature
...
class RuntimebuzzArticleNetsimFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _simulate(RuntimebuzzArticleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RuntimebuzzArticleContext $ctx, array $applied): void
    {
        $client = $this->client;
