...
// RuntimebuzzArticle SDK timeout feature
...
class RuntimebuzzArticleTimeoutFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _with_timeout(RuntimebuzzArticleContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RuntimebuzzArticleContext $_ctx, float $ms): void
    {
        $client = $this->client;
