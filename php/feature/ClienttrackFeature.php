...
// RuntimebuzzArticle SDK clienttrack feature
...
class RuntimebuzzArticleClienttrackFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    public function PostConstruct(RuntimebuzzArticleContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RuntimebuzzArticle-SDK';
