...
// RuntimebuzzArticle SDK metrics feature
...
class RuntimebuzzArticleMetricsFeature extends RuntimebuzzArticleBaseFeature
{
    ...
    private function _record(RuntimebuzzArticleContext $ctx, bool $ok): void
    {
