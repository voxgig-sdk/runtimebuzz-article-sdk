...
// RuntimebuzzArticle SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RuntimebuzzArticleMakeRequest
{
    public static function call(RuntimebuzzArticleContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RuntimebuzzArticleResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RuntimebuzzArticleResponse($fetched);
        } else {
