...
// RuntimebuzzArticle SDK utility: graphql
//
...
class RuntimebuzzArticleGraphql
{
    ...
    // equivalent.
    public static function body(RuntimebuzzArticleContext $ctx): mixed
    {
    ...
    public static function errors(RuntimebuzzArticleContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
