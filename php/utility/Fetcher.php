...
// RuntimebuzzArticle SDK utility: fetcher

class RuntimebuzzArticleFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RuntimebuzzArticleSDK/1.0)';
    ...
    public static function call(RuntimebuzzArticleContext $ctx, string $fullurl, array $fetchdef): array
    {
