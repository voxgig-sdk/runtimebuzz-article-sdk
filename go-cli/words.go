...
func registerSDKWords(r *eng.Registry, client *sdk.RuntimebuzzArticleSDK) {
...
func runOp(client *sdk.RuntimebuzzArticleSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
