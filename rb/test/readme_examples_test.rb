...
#      offline in seeded test mode (RuntimebuzzArticleSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RuntimebuzzArticle_sdk.rb")
  SDK_CLASS = "RuntimebuzzArticleSDK"
  ...
  SDK_BASE = "RuntimebuzzArticle_sdk"
